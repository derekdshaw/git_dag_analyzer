...
pub fn report_commits(container: &ObjectContainer) {
    ...
    println!("Largest Commit Object Size: {}", display_size(largest_commit_size as u64));
    println!("Largest Commit Object Id: {}", container.commits().lookup_hash_for_index(&largest_commmit_index).unwrap());
    println!("Largest Contributing Commit Size: {}", display_size(largest_contributing_size));
    println!("Largest Contributing Commit Object Id: {}\n\n", container.commits().lookup_hash_for_index(&largest_contributing_commit_index).unwrap());
